...
export default function Portfolio() {
  return (
    ...
    <a href="zesty-smile.surge.sh" className='btn btn-primary' target="_blank">Live Demo</a>
    </div>
    </article>
    ...
    <div className="portfolio_item-cta">
    <a href="https://github.com" className='btn' target="_blank">Gighub</a>
    <a href="cooperative-protest.surge.sh" className='btn btn-primary' target="_blank">Live Demo</a>
    </div>
